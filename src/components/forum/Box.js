...
return (
    ...
    <Card >
      <Card.Body>
                    ...
                    <div className=" align-items flex-star-stretch" >
                    ...
                    <label for="formGroupExampleInput" className="form-label flex-space-around ">
                     ...
                     <div type="text" class="form-control"  > <h5> <FontAwesomeIcon icon={ faList} />Препоръки </h5>
                    
                     <div type="text" > В тази подсекция ще намерите препоръчани книги,книги с най-висок рейтинг, новоизддени книги,интерсни нови произведения.                 </div>
                     </div>
                     </label>
                     
                     <label for="formGroupExampleInput" class="form-label">
                     <div type="text" class="form-control"  > <h5> Лично творчество </h5>
                     <div type="text" > В тази подсекция ще намерите различни авторски разкази,гатанки,приказки и т.н. </div>
                     </div>
                     </label>

                     <label for="formGroupExampleInput" class="form-label">
                     <div type="text" class="form-control"  > <h5> Общи приказки </h5>
                     <div type="text" > В тази подсекция ще намерите разни теми, разни идеали,коментари,съвети и т.н. </div>
                     </div>
                     </label>
                     ...
                     <label for="formGroupExampleInput" class="form-label">
                     <div type="text" class="form-control"  > <h5> Забавни истории </h5>
                     <div type="text" > В тази подсекция ще намерите различни интересни истории както от автори на книги така и от читатели.  </div>
                     </div>
                     </label>
     
                     <label for="formGroupExampleInput" class="form-label">
                     <div type="text" class="form-control"  > <h5> Начинания </h5>
                     <div type="text" > В тази подсекция ще намерите нови появили се  идеи за странични проекти. Обсъждайте ги тук. </div>
                     </div>
                     </label>
